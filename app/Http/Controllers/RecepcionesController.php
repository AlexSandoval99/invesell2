...
class RecepcionesController extends Controller
{
    public function index()
    {
        ...
        return view('pages.recepciones.index', compact('recepciones'));
    }
    public function view($id)
    {
        ...
        // return $detalle;
        return view('pages.recepciones.view', compact(['recepcion', 'detalle']));
    }
    public function create()
    {
        $proveedores = Proveedor::all();
        $articulos = Articulo::all();
        return view('pages.recepciones.create', compact(['proveedores', 'articulos']));
    }
    public function addArticulo(Request $request)
    {
        ...
        return view('pages.recepciones.create', compact(['proveedores', 'articulos', 'tipo_documento']));
    }
