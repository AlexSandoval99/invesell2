...
class ClientesController extends Controller
{
    ...
    {
        $clientes = Cliente::whereNotNull('nombre');
        if(request()->s)
        {
            $clientes = $clientes->where('nombre','like','%'.request()->s.'%')->orWhere('rut','like','%'.request()->s.'%');
        }
    ...
    {
         $regiones = Region::all();
         return view('pages.clientes.crear', compact('regiones'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return view('pages.clientes.editar', compact(['cliente','regiones','comunas']));
        }
    }
