...
class mediosdepagoController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.administracion.mediosdepago.index', compact('medio'));
    }
    ...
    {
        return view('pages.administracion.mediosdepago.crear');
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.administracion.mediosdepago.editar', compact('medio'));
    }
