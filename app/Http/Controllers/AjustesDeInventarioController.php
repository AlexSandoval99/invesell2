...
class AjustesDeInventarioController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.ajustesdeinventario.index', compact('ajustesDeInventario'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.ajustesdeinventario.create', compact(['articulos', 'tipo_movimientos']));
    }
    ...
    public function view($id)
    {
        ...
        return view('pages.ajustesdeinventario.view', compact(['ajuste', 'detalle']));
    }
