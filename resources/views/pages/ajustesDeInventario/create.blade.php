                    ...
                    <tbody>
                        @foreach (session('ajuste') as $r)
                            <tr>
                                ...
                                @endif
                                <td>Gs {{ number_format($r->costo_neto, 0, ',', '.') }}</td>
                                <td>Gs {{ number_format($r->costo_imp, 0, ',', '.') }}</td>
                                @if ($r->entradas > 0)
                                    <td>Gs {{ number_format(($r->costo_neto + $r->costo_imp) * $r->entradas, 0, ',', '.') }}
                                    </td>
                                @endif
                                @if ($r->salidas > 0)
                                    <td>Gs -{{ number_format(($r->costo_neto + $r->costo_imp) * $r->salidas, 0, ',', '.') }}
                                    </td>
                                    </td>
                                @endif
                            </tr>
